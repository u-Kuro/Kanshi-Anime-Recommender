...
self.onmessage = async ({ data }) => {
    ...
    const username = (await retrieveJSON("username")) ?? null;
    let backUpData = {
        username,
        ...
        tagCategoryInfo: await retrieveJSON("tagCategoryInfo"),
        selectedCustomFilter: await retrieveJSON("selectedCustomFilter"),
