        ...
        try {
            ...
            if (blobs.tagInfo instanceof Blob) {
                ...
                if (isJsonObject(tagInfo) && !jsonIsEmpty(tagInfo)) {
                    if (blobs.tagInfoUpdateAt instanceof Blob) {
            ...
            if (
                ...
                blobs.mediaEntriesInfo instanceof Blob &&
                ...
                recordsToSet.mediaEntriesInfo = blobs.mediaEntriesInfo
