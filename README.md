# Kanshi — Animanga Recommendation System
...
The algorithm has two modes — one for users who have rated titles, one for those who haven't.

### For users with a rated history
...
### For users with no rated history

A general quality formula is used instead: a title's score is calculated as the ratio of favorites to total trackers, multiplied by the community rating. This surfaces titles that are both well-regarded and disproportionately loved relative to how widely known they are — a reasonable proxy for quality without any personal data.

## Android / Website
[<img src="./images/download-button.png" width="144px;"/>](https://github.com/u-Kuro/Kanshi-Anime-Recommender/releases/download/v9.5.1/Kanshi-v9.5.1.apk)
[<img src="./images/visit-web-button.png" width="144px;"/>](https://kanshi.vercel.app)

## Android Preview
<div>
  <img src="./images/android-preview-1.png" style="width:300px;">
  <img src="./images/android-preview-2.png" style="width:300px;">
  <img src="./images/android-preview-3.png" style="width:300px;">
  <img src="./images/android-preview-4.png" style="width:300px;">
</div>
